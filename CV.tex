...
I am an innovative and collaborative experimental physicist with over a decade
of experience dedicated to probing beyond the Standard Model physics using the 
Large Hadron Collider (LHC). My research encompasses both collaborative and 
independent environments. Within collaborative efforts, I have extensively explored
Supersymmetry and Exotic particles utilizing a diverse array of experimental techniques.
Additionally, I have contributed acgtively to detector upgrades, authored scientific 
publications, and delivered presentations at prestigious physics conferences.
In the future, my research interests extend to the search of Dark Matter particles at 
the LHC and non-collider experiments. I also have a strong inclination towards applying 
Machine Learning methodologies to enhance the scope and depth of physics research. 
Complementing my technical skill, I have exceptional interpersonal and communication skills. 
Bellow are the highlights of my diverse and impactful contributions to the field of particle physics.


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%Education
\input{acdm/education}
...
\input{acdm/conference}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%References
\newpage
\input{acdm/references}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%References
\input{acdm/publications}
